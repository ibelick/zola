...
export const API_ROUTE_AGENT_RESEARCH = "/api/agents/research"
export const API_ROUTE_AGENT_REASONING = "/api/agents/reasoning"
export const API_ROUTE_AGENT_CALL = "/api/agents/handle"
