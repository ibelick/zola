  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        ...
        className={cn("overflow-hidden p-0 h-[75vh]", dialogContentClassName)}
      >
        <Command
          className={cn(
            "[&_[cmdk-group-heading]]:text-muted-foreground [&_div[cmdk-input-wrapper]]:h-12 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group]]:px-2 [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:pt-0 [&_[cmdk-input-wrapper]_svg]:h-5 [&_[cmdk-input-wrapper]_svg]:w-5 [&_[cmdk-input]]:h-12 [&_[cmdk-item]]:px-2 [&_[cmdk-item]]:py-3 [&_[cmdk-item]_svg]:h-5 [&_[cmdk-item]_svg]:w-5",
            className
          )}
          {...commandProps}
        >
