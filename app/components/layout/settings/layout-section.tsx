...
const LayoutSidebar = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <g clipPath="url(#a)">
        <path fill="#FCFCFC" d="M0 0h1028v578H0z" />
        <mask id="b" fill="#fff">
          <path d="M177 86c0-8.836 7.163-16 16-16h638c8.837 0 16 7.163 16 16v405c0 8.837-7.163 16-16 16H193c-8.837 0-16-7.163-16-16z" />
        </mask>
        <path
          fill="#fff"
        ...
        <path
          ...
          mask="url(#b)"
        />
        <rect width={369} height={72} x={398} y={411} fill="#F7F7F7" rx={16} />
        <rect
          width={214.628}
          height={69}
          x={398}
        ...
        />
        <path stroke="#EBEBEB" d="M398 386.5h369" />
        <path
          fill="#EBEBEB"
      ...
      <defs>
        <clipPath id="a">
          <path fill="#fff" d="M0 0h1028v578H0z" />
        </clipPath>
      </defs>
    </svg>
  )
    ...
    >
      <g clipPath="url(#a)">
        ...
        <path
          ...
          mask="url(#b)"
        />
        <rect width={414} height={72} x={305} y={411} fill="#F7F7F7" rx={16} />
        <rect width={248} height={69} x={305} y={294} fill="#F7F7F7" rx={8} />
        <path
          fill="#EBEBEB"
        ...
        />
        <rect width={248} height={69} x={471} y={201} fill="#F7F7F7" rx={8} />
        <path
          fill="#EBEBEB"
        ...
        <path
          ...
          d="M203 90a6 6 0 1 0-12 0 6 6 0 0 0 12 0M223 90a6 6 0 1 0-12 0 6 6 0 0 0 12 0M243 90a6 6 0 1 0-12 0 6 6 0 0 0 12 0"
        />
        <path stroke="#EBEBEB" d="M305 386.5h414" />
      </g>
      <defs>
        <clipPath id="a">
          <path fill="#fff" d="M0 0h1028v578H0z" />
